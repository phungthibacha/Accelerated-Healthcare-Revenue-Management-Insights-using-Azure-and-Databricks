...
# MAGIC %sql
# MAGIC -- Data quality check for transaction data, if EncounterID/ PatientID/ TransactionID/ VisitDate are null then is_quarantined is true
# MAGIC CREATE OR REPLACE TEMP VIEW quality_checks AS
# MAGIC SELECT concat(TransactionID, '-', datasource) as TransactionID,
...
# MAGIC         OR VisitDate IS NULL THEN TRUE
# MAGIC         ELSE FALSE
